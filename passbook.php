...
<div  class="container-fluid">
  ...
  <div class="col-sm-2">
    ...
    $sql = "select * from transaction where payer='$login_session'or payee='$login_session' order by tid desc";
    ...
    if ($count > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr><td>" . $row["tid"] . "</td><td>" . $row["payer"] . " </td><td>" . $row["payee"] . "</td><td>" . $row["amount"] . "</td><td>" . $row["time"] . "</td></tr>";
      }

    } else {
      echo "You have not done any transactions";
    }
