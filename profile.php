...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <h2 style="color:#0D477C;">Personal Info</h2><br><div style="overflow-x:auto;"><table  >
      <?php
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          echo "<tr><td>" . "Name: " . "</td>" . "<td>" . $row["name"] . "</td></tr>" . "<tr><td>" . "Hhtno: " . "</td>" . "<td>" . $row["htno"] . "</td></tr>" . "<tr><td>" . " Mobile: " . "</td>" . "<td>" . $row["mobile"] . "</td></tr>" . "<tr><td>" . "Email:" . "</td>" . "<td>" . $row["email"] . "</td></tr>";
        }
      } else {
        echo "0 results";
      }
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <h2 style="color:#0D477C;">Change password</h2><br>
      <div class="container">
...
<!-- Container (change pin Section) -->
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <h2 style="color:#0D477C;">Change PIN</h2><br>
      <div class="container">
 
  <form method="post" action="changepin.php">
 
   <br> Old PIN:<br>
      <input type="password"  name="opin" placeholder="Enter Old PIN">
 
   
 <br>New PIN:<br>
      <input type="password"  name="npin" placeholder="Enter new Pin">
 
  
    <br>Confirm PIN:<br>
      <input type="password"  name="cpin" placeholder="Confirm Pin">
    <br>
