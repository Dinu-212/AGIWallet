...
$query = "INSERT INTO register VALUES ('$name','$htno','$mobile','$emailid','$password','$pin','0')";
...
It is a web application  developed for  cashless transactions and a major problem for exchange of money can be eliminated. 
<br><br>
